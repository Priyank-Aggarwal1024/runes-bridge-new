import { ani1, ani2, ani3, anism1, anism2, anism3, anism4, bitcoin, co1, co2, co3, co4, co5, comp1, comp2, comp3, comp4, comp5, comp6, drone, drone2, evm, gl1, gl2, gl3, gl4, gl5, gl6, gl7, gl8, gl9, gr1, gr2, gr3, gr4, gr5, gr6, herow, l2, leadingline, logol, runes, solana, zetachain } from "../assets";
...
function Home() {
    ...
    return (
        <div className="w-full bg-[#FCFCFC]">
            ...
            <div className="w-[1440px] max-w-full bg-white flex justify-center lg:py-[96px] py-[64px] xl:py-[150px]">
            ...
            <div className="xl:px-[133px] p-4 md:p-8 xl:py-[100px] flex-col justify-start items-start gap-4 inline-flex w-full  bg-[#FCFCFC]">
                ...
                <div className="w-[1173px] max-w-full">
            ...
            <div className="lg:px-16 md:px-8 px-4 w-full overflow-x-hidden lg:py-[156px] py-20  bg-[#FCFCFC]">
                <div className="flex-col justify-start items-start gap-[156px] inline-flex w-full">
                    <div className="sm:w-[636px] xs:w-full w-[291px] max-w-full">
                        <div className="w-[636px] max-w-full text-[#232323] lg:text-[48px] md:text-[36px] sm:text-[30px] text-[24px] xl:text-6xl font-semibold font-['Bricolage Grotesque'] tracking-[0.96px] md:tracking-widest">Powerful and Solid Bridging Mechanism</div>
                    ...
                    <div className="lg:pt-20 md:pt-10 pt-6 w-full flex flex-col md:gap-[30px] gap-4 lg:gap-[45px]">
                        <div className="hbc flex justify-between w-full md:px-16 px-4 lg:px-[120px] min-h-[158px] lg:min-h-[560px] items-center rounded-[20px] bg-[#F9FAF9] py-4 lg:order-1">
                            ...
                            <div className="w-[35%] flex justify-center ">
                                <img src={ani1} alt="Ani1" className="lg:w-[280px] lg:block hidden" />
                                <img src={anism1} alt="Ani1" className="lg:hidden w-[80%]" />
                            </div>
                        </div>
                        <div className="hbc flex justify-between w-full md:px-16 px-4 lg:px-[120px] min-h-[158px] lg:min-h-[560px] items-center rounded-[20px] bg-[#F9FAF9] py-4 lg:order-1">
                            <div className="w-full">
                            ...
                            <div className="w-[35%] flex justify-center ">
                                <img src={ani2} alt="Ani1" className="lg:w-[280px] lg:block hidden" />
                                <img src={anism2} alt="Ani1" className="lg:hidden w-[80%]" />
                            </div>
                        </div>
                        <div className="hbc flex justify-between w-full md:px-16 px-4 lg:px-[120px] min-h-[158px] lg:min-h-[560px] items-center rounded-[20px] bg-[#F9FAF9] py-4 lg:order-1 order-2">
                            ...
                            <div className="w-[35%] flex justify-center ">
                                <img src={ani3} alt="Ani1" className="lg:w-[280px] lg:block hidden" />
                                <img src={anism4} alt="Ani1" className="lg:hidden w-[80%]" />
                            </div>
                        </div>
                        <div className="hbc flex justify-between w-full md:px-16 px-4 lg:px-[120px] min-h-[158px] lg:min-h-[560px] items-center rounded-[20px] bg-[#F9FAF9] py-4 lg:order-1">
                            <div className="w-full">
                            ...
                            <div className="flex justify-center w-[35%] ">
                                <img src={ani3} alt="Ani1" className="lg:w-[280px] lg:block hidden" />
                                <img src={anism3} alt="Ani1" className="lg:hidden w-[80%]" />
                            </div>
                        </div>
                    </div>
